...
Matrix_ Matrix_::operator *(Matrix_ &m)	// return MatrixMulMatrix(this, m)
{
	Matrix_ temp;
...
Vector_ Matrix_::operator *(Vector_ &v)	// return MatrixMulVector(this, v)
{
	Vector_	temp;
...
Matrix_ Matrix_::operator *(float f)		// return MatrixScale(this, f)
{
	Matrix_ temp;
...
void Matrix_::operator *=(Matrix_ &m)		// this = MatrixMulMatrix(this, m)
{
	*this = *this * m;
}


void Matrix_::operator *=(float f)		// this = MatrixScale(this, f)
{
	*this = *this * f;
}

Matrix_ Matrix_::operator !()				// return MatrixInverse(this)
{
	Matrix_ temp;
...
void Matrix_::Set(	float xx, float xy, float xz,
...
void Matrix_::SetAng(float ax, float ay, float az)
{
